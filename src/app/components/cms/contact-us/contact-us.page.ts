...
export class ContactUsPage implements OnInit {
  ...
  validation_messages = {
    first_name: [
      {
        type: 'required',
        message: 'First Name Type is required',
      },
    ],
    last_name: [
      {
  ...
  ngOnInit() {
    ...
    for(var i=0; i < this.mobileCountryCode?.length; i++){
      if(this.mobileCountryCode[i].name === 'India'){
        this.validationForm.controls['phone_code'].setValue(this.mobileCountryCode[i].code)
      }
    }
  }
  ...
  submit(){
    ...
    formData.append("full_name", formValue.first_name + ' ' +formValue.last_name)
    formData.append("email", formValue.email)
    formData.append("contact", formValue.phone_number)
    formData.append("message", formValue.message)
    formData.append("phone_code", formValue.phone_code)
